...
------ DROP DE CONSTRAINTS ------
ALTER TABLE tabela1 DROP CONSTRAINT uq_nome_tab1;

------ DROP DE CONSTRAINTS ------

------ DROP DE CONSTRAINTS ------
ALTER TABLE tabela3 DROP CONSTRAINT cd1_id1_fk;
ALTER TABLE tabela3 DROP CONSTRAINT fk_tabela1;
ALTER TABLE tabela3 DROP CONSTRAINT uq_descricao;
ALTER TABLE tabela3 DROP CONSTRAINT uq_mais;
